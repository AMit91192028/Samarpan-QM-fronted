...
export default function BankingIncrease() {
        ...
        <>
            <div className="flex items-center justify-center mt-[60px] Centralize shadow-[0_-8px_8px_rgba(0,0,0,0.15)] px-4 sm:px-0 mx-auto">
                  ...
                  <div className="w-full sm:w-1/2 flex justify-center sm:justify-end sm:mt-0">
                      <img
                        src="/public/ALL-IMAGES/increase.png"
                    ...
                    <div className="w-full sm:w-1/2 text-center sm:text-left">
                      ...
                      <div className="text-[16px] sm:text-[18px] ">
                        <List list="Digital interaction platforms such as signage and kiosks help provide valuable information to customers while they are waiting." />
                        <List list="Queuing systems with appointment scheduling features encourage customer engagement by allowing them to plan visits at their convenience." />
                        <List list="Smart queue management system for banks sends automated notifications about their queue status or upcoming appointments." />
                      </div>
                    </div>
